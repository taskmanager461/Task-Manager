...
function renderHeroMetrics(score) {
    ...
    container.innerHTML = `
        ...
        <div class="hero-metric" style="background-color: transparent !important;">
            <div class="hero-metric-bg" style="background-image: url('${img2}'); background-size: 130% 130%;"></div>
            <div class="hero-metric-content">
                ...
                <div class="status-badge-container ${label.class}" style="background-image: url('${img3}'); background-size: 320px 185px; background-position: ${statusPos}; width: 150px; height: ${badgeHeight}; margin-top: ${badgeMarginTop}; margin-left: ${badgeMarginLeft}; margin-right: auto; mix-blend-mode: screen !important; box-shadow: none !important;">
                    ${label.text}
                </div>
            </div>
        </div>
        ...
        <!-- Card 2: Streak -->
        <div class="hero-metric" style="background-color: transparent !important;">
            <div class="hero-metric-bg" style="background-image: url('${img5}'); background-size: 130% 130%;"></div>
            <div class="hero-metric-content">
                <div class="hero-metric-icon">
                    <img src="${img4}">
                </div>
        ...
        <!-- Card 3: Success -->
        <div class="hero-metric" style="background-color: transparent !important;">
            <div class="hero-metric-bg" style="background-image: url('${img7}'); background-size: 130% 130%;"></div>
            <div class="hero-metric-content">
                <div class="hero-metric-icon">
                    <img src="${img6}">
                </div>
