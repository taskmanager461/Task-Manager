...
const translations = {
    ...
    el: {
        ...
        confirm_password: "Επιβεβαίωση κωδικού", update_password: "Ενημέρωση", full_name: "Ονοματεπώνυμο", email: "Email",
    ...
    de: {
        ...
        dashboard: "Dashboard", reports: "Berichte", me: "Ich", tasks: "Aufgaben", insights: "Einblicke",
    ...
    ru: {
        ...
        confirm_password: "Подтвердить пароль", update_password: "Обновить", full_name: "Полное имя", email: "Email",
    ...
    ja: {
        ...
        well_done: "よくできました！", keep_going: "その調子！", streak_saved: "連続達成維持！", multiplier: "{value}xブースト",
