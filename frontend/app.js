...
function renderHeroMetrics(score) {
    ...
    container.innerHTML = `
        <!-- Card 1: Trust Score -->
        <div class="hero-metric" style="background-color: transparent !important; border: none !important; box-shadow: none !important;">
            <div class="hero-metric-bg" style="background-image: url('${img2}'); background-size: 130% 130%; mix-blend-mode: screen !important;"></div>
            <div class="hero-metric-content">
                <div class="hero-metric-icon" style="mix-blend-mode: screen !important;">
                    <img src="${img1}" style="mix-blend-mode: screen !important;">
                </div>
                <div class="hero-metric-label">Self Trust Score</div>
                <div class="hero-metric-value">${scoreVal}</div>
                <div class="status-badge-container" style="background-image: url('${img3}'); background-size: 320px 185px; background-position: ${statusPos}; background-color: transparent !important; width: 150px; height: ${badgeHeight}; margin-top: ${badgeMarginTop}; margin-left: ${badgeMarginLeft}; margin-right: auto; mix-blend-mode: screen !important; border: none !important; box-shadow: none !important;"></div>
            </div>
        </div>

        <!-- Card 2: Streak -->
        <div class="hero-metric" style="background-color: transparent !important; border: none !important; box-shadow: none !important;">
            <div class="hero-metric-bg" style="background-image: url('${img5}'); background-size: 130% 130%; mix-blend-mode: screen !important;"></div>
            <div class="hero-metric-content">
                <div class="hero-metric-icon" style="mix-blend-mode: screen !important;">
                    <img src="${img4}" style="mix-blend-mode: screen !important;">
                </div>
        ...
        <!-- Card 3: Success -->
        <div class="hero-metric" style="background-color: transparent !important; border: none !important; box-shadow: none !important;">
            <div class="hero-metric-bg" style="background-image: url('${img7}'); background-size: 130% 130%; mix-blend-mode: screen !important;"></div>
            <div class="hero-metric-content">
                <div class="hero-metric-icon" style="mix-blend-mode: screen !important;">
                    <img src="${img6}" style="mix-blend-mode: screen !important;">
                </div>
