...
function renderHeroMetrics(score) {
    ...
    container.innerHTML = `
        ...
        <div class="hero-metric" style="background-image: url('${img2}'); background-size: 120% 120%; background-position: center; background-color: transparent !important; filter: saturate(1.8) brightness(1.2);">
            <div class="hero-metric-icon" style="filter: none !important;">
                <img src="${img1}">
            </div>
            <div class="hero-metric-label">Self Trust Score</div>
            <div class="hero-metric-value">${scoreVal}</div>
            <div class="status-badge-container" style="background-image: url('${img3}'); background-size: 300px 172px; background-position: ${statusPos}; background-color: transparent !important; width: 150px; height: ${badgeHeight}; margin-top: ${badgeMarginTop}; margin-left: ${badgeMarginLeft}; margin-right: auto; filter: none !important;"></div>
        </div>
