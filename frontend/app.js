...
const translations = {
    en: {
        ...
        due_date: "Due Date", overdue: "Overdue", all: "All", filter_by: "Filter by", productive_day: "Most Productive Day",
        productive_hour: "Most Productive Hour", trends: "Completion Trends", failure_patterns: "Failure Patterns", achievements: "Achievements",
        well_done: "Well done!", keep_going: "Keep it up!", streak_saved: "Streak maintained!", multiplier: "{value}x Boost",
        tasks_count: "{count} tasks today", smart_suggestion: "Smart Suggestion", best_time_to_create: "You are most active now! Great time to plan tasks.",
        suggest_simpler: "This task seems complex. Try breaking it down?", high_risk: "High risk of failure based on your history for this time/category.",
        optimal_time: "Optimal time to complete this: ", most_productive_day: "Your most productive day is ", most_productive_hour: "You get most things done around ",
        failure_pattern: "You tend to struggle more with tasks in ", theme: "Theme", toggle_dark: "Toggle Dark Mode", language: "Language",
        app_info: "App Info", version: "Version", completed: "Completed", failed: "Failed", pending: "Pending", no_tasks: "No tasks for today. Add one above!",
        ...
        inst_tasks_title: "Tasks", inst_tasks_desc: "Create new tasks by pressing '+'. You can set priority and category. Check the circle to complete them and earn points.",
        ...
        inst_gestures_title: "Gestures & Navigation", inst_gestures_desc: "Swipe left or right to quickly switch between the app's pages."
    },
    el: {
        app_title: "Tobedone",
    ...
    it: {
        app_title: "Tobedone", login: "Accedi", signup: "Registrati", continue_with_google: "Continua con Google", or: "o",
        ...
        verification_code: "Codice di verifica", verify_code: "Verifica codice", reset_code: "Codice di reset", use_code: "Usa codice",
        resend_verification: "Reinvia email", reset_password_title: "Nuova password", new_password: "Nuova password",
        confirm_password: "Conferma password", update_password: "Aggiorna", full_name: "Nome completo", email: "Email",
