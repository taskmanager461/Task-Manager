...
const translations = {
    ...
    el: {
        ...
        notif_level_up: "Άνοδος Επιπέδου",
        ...
        share_progress: "Κοινοποίηση Προόδου",
        download: "Λήψη",
        ...
        task_statistics: "Στατιστικά Εργασιών",
        goals_achieved: "Επιτεύχθηκε",
        trust_low: "Χαμηλός",
        trust_average: "Μέσος",
        trust_good: "Καλός",
        trust_excellent: "Εξαιρετική",
        ...
        ach_zero_miss_day: "Μέρα χωρίς αποτυχίες",
        ...
        ach_comeback_king: "Βασιλιάς της Επιστροφής",
        ...
        ach_one_year_strong: "Ένας χρόνος δυνατός",
        ach_one_year_strong_desc: "Παραμείνετε ενεργοί για 365 ημέρες.",
        ach_century_streak: "Σερί Αιώνα",
        ...
        ach_tobedone_legend: "Θρύλος του Tobedone",
    ...
    multiplier: "{value}x Ενίσχυση",
        ...
        tasks_subtitle: "Οι ενεργές εργασίες σου",
        ...
        not_enough_data: "Μη επαρκή δεδομένα",
        tue: "Τρι",
        wed: "Τετ",
        thu: "Πεμ",
        fri: "Παρ",
        ...
        rec_lvl10_desc: "Φτάσε το Επίπεδο 10",
        rec_streak7_title: "🔥 Σερί 7 Ημερών",
        rec_streak7_desc: "Διατήρησε σερί 7 ημερών",
        rec_streak30_title: "🔥 Σερί 30 Ημερών",
        rec_streak30_desc: "Διατήρησε σερί 30 ημερών",
        rec_goal_title: "🎯 Master Στόχων",
        rec_goal_desc: "Ολοκλήρωσε 10 στόχους",
        rec_elite_title: "⭐ Κατάσταση Ελίτ",
        rec_elite_desc: "Φτάσε το Rank: Ελίτ",
        rec_habit_title: "📅 Χτίστης Συνηθειών",
        rec_habit_desc: "Δημιούργησε 5 συνήθειες",
        chal_tasks_title: "Ολοκλήρωσε 5 εργασίες",
        chal_tasks_desc: "Ξεπέρασε τα όριά σου",
        chal_streak_title: "Φτάσε σερί 3 ημερών",
        chal_streak_desc: "Η συνέπεια είναι το κλειδί",
        future_placeholder: "Γράψε ένα γράμμα...",
        future_dear: "Αγαπητέ μου...",
        loading: "Φόρτωση...",
        ...
        achieved_failed: "Επιτεύχθηκε / Απέτυχε",
        achieved: "Επιτεύχθηκε",
        failed_status: "Αποτυχία",
        longest_streak: "Μεγαλύτερο Σερί",
        highest_xp: "Υψηλότερο XP",
        max_tasks_day: "Μέγιστες Εργασίες (Ημέρα)",
        tasks_word: "Εργασίες",
        goals_word: "Στόχοι",
        ms_first_step: "Πρώτο Βήμα",
        ms_first_step_desc: "Ολοκλήρωσε την πρώτη εργασία",
        ms_goal_setter: "Στόχος Τέθηκε",
        ms_goal_setter_desc: "Βάλε τον πρώτο σου στόχο",
        ms_lvl10: "Επίπεδο 10",
        ms_lvl10_desc: "Φτάσε το Επίπεδο 10",
        ms_trust_builder: "Χτίστης Εμπιστοσύνης",
        ms_trust_builder_desc: "Ανέβασε την εμπιστοσύνη > 50",
        ms_discipline_elite: "Ελίτ Πειθαρχίας",
        ms_discipline_elite_desc: "Φτάσε Επίπεδο 25",
        ms_legendary: "Θρυλικός",
        ms_legendary_desc: "100 εργασίες, επίπεδο 50",
        locked: "Κλειδωμένο",
        unlocked_status: "Ξεκλείδωτο",
        weekly_perf_card: "Εβδομαδιαία Επίδοση",
        weekly_perf_desc: "Αυτόματα εβδομαδιαία στατιστικά",
        monthly_perf_card: "Μηνιαία Επίδοση",
        monthly_perf_desc: "Αναλυτικά μηνιαία στατιστικά",
        ...
        chal_summer_desc: "Ολοκλήρωσε 10 εργασίες για ενίσχυση.",
        chal_30day: "Συνέπεια 30 Ημερών",
        chal_30day_desc: "Διατήρησε ένα σερί 30 ημερών.",
        in_progress: "Πρόοδος",
        xp_reward_500: "+500 XP",
        xp_reward_1500: "+1500 XP",
        sent: "Απεσταλμένο",
        ready: "Έτοιμο",
        opened: "Ανοιχτό",
        no_messages_yet: "Δεν υπάρχουν μηνύματα. Γράψτε το πρώτο!",
        ready_to_open: "Έτοιμο για άνοιγμα!",
        fs_promise: "🤝 Υπόσχεση",
        fs_prediction: "🔮 Πρόβλεψη",
        fs_reminder: "🔔 Υπενθύμιση",
        fs_motivational: "💪 Κίνητρο",
        no_achievements: "Δεν υπάρχουν επιτεύγματα",
        for_you_default_body: "Συνέχισε τις εργασίες για να ξεκλειδώσεις οδηγίες",
        profile_updated: "Το προφίλ ενημερώθηκε",
        profile_update_failed: "Αποτυχία ενημέρωσης προφίλ",
        profile_link_copied: "Ο σύνδεσμος αντιγράφηκε",
        insight_start_streak: "Ξεκίνα Σερί",
        insight_start_streak_body: "Ολοκλήρωσε κάτι",
        levels_to_rank: "Επίπεδα για Rank Up",
        reach_level: "Φτάσε το Επίπεδο",
        to_unlock: "για ξεκλείδωμα",
        rank_push: "Συνέχισε δυνατά!",
        tasks_to_milestone: "Εργασίες για Ορόσημο",
        complete: "Ολοκλήρωση",
        more_tasks_milestone: "περισσότερες εργασίες για το",
    ...
    es: {
        ...
        well_done: "¡Bien hecho!", keep_going: "¡Sigue así!", streak_saved: "¡Racha mantenida!", multiplier: "{value}x Mejora",
        active: "Activo",
        archived: "Archivado",
        excellent: "Excelente",
        good: "Bien",
        ...
        ach_zero_miss_day: "Día sin fallos",
        ...
        ach_century_streak: "Racha Centenaria",
        ...
        ach_tobedone_legend: "Leyenda Tobedone",
        ...
        tasks_subtitle: "Tus tareas activas",
        ...
        november: "Noviembre",
        december: "Diciembre",
        rec_lvl10_title: "🏆 Nivel 10 Alcanzado",
        rec_lvl10_desc: "Alcanza el Nivel 10",
        rec_streak7_title: "🔥 Racha de 7 Días",
        rec_streak7_desc: "Mantén una racha de 7 días",
        rec_streak30_title: "🔥 Racha de 30 Días",
        rec_streak30_desc: "Mantén una racha de 30 días",
        rec_goal_title: "🎯 Maestro de Objetivos",
        rec_goal_desc: "Completa 10 objetivos",
        rec_elite_title: "⭐ Estado Élite",
        rec_elite_desc: "Alcanza el Rango: Élite",
        rec_habit_title: "📅 Constructor de Hábitos",
        rec_habit_desc: "Crea 5 hábitos",
        chal_tasks_title: "Completa 5 tareas",
        chal_tasks_desc: "Supera tus límites",
        chal_streak_title: "Alcanza una racha de 3 días",
        chal_streak_desc: "La consistencia es clave",
        future_placeholder: "Escribe una carta...",
        future_dear: "Querido yo...",
        loading: "Cargando...",
        ...
        achieved_failed: "Logrado / Fallido",
        achieved: "Logrado",
        failed_status: "Fallido",
        longest_streak: "Racha más larga",
        highest_xp: "XP más alto",
        max_tasks_day: "Max tareas al día",
        tasks_word: "Tareas",
        goals_word: "Objetivos",
        ms_first_step: "Primer Paso",
        ms_first_step_desc: "Completa tu primera tarea",
        ms_goal_setter: "Establecedor de Objetivos",
        ms_goal_setter_desc: "Establece tu primer objetivo",
        ms_lvl10: "Nivel 10",
        ms_lvl10_desc: "Alcanza el Nivel 10",
        ms_trust_builder: "Constructor de Confianza",
        ms_trust_builder_desc: "Sube la confianza > 50",
        ms_discipline_elite: "Élite de Disciplina",
        ms_discipline_elite_desc: "Alcanza Nivel 25",
        ms_legendary: "Legendario",
        ms_legendary_desc: "100 tareas, nivel 50",
        locked: "Bloqueado",
        unlocked_status: "Desbloqueado",
        weekly_perf_card: "Rendimiento Semanal",
        weekly_perf_desc: "Estadísticas de actividad semanal autogeneradas",
        monthly_perf_card: "Rendimiento Mensual",
        monthly_perf_desc: "Métricas de rendimiento mensuales detalladas",
        ...
        chal_summer_desc: "Completa 10 tareas para una mejora.",
        chal_30day: "Consistencia de 30 Días",
        ...
        ready: "Listo",
        opened: "Abierto",
        no_messages_yet: "No hay mensajes. ¡Escribe el primero!",
        ready_to_open: "¡Listo para abrir!",
        fs_promise: "🤝 Promesa",
        fs_prediction: "🔮 Predicción",
        fs_reminder: "🔔 Recordatorio",
        fs_motivational: "💪 Motivación",
        no_achievements: "Sin logros aún",
        for_you_default_body: "Sigue completando tareas",
        profile_updated: "Perfil actualizado",
        profile_update_failed: "Error al actualizar perfil",
        profile_link_copied: "Enlace copiado",
        insight_start_streak: "Empieza la Racha",
        insight_start_streak_body: "Completa algo",
        levels_to_rank: "Niveles para Subir",
        reach_level: "Alcanza el Nivel",
        to_unlock: "para desbloquear",
        rank_push: "¡Sigue así!",
        tasks_to_milestone: "Tareas para Hito",
        complete: "Completar",
        more_tasks_milestone: "tareas más para",
        ...
        completed_tasks_total: "Total completado",
        completed_tasks_today: "Completado hoy",
        completed_tasks_this_week: "Esta semana",
        completed_tasks_this_month: "Este mes",
    ...
    fr: {
        ...
        well_done: "Bien joué!", keep_going: "Continuez!", streak_saved: "Série maintenue!", multiplier: "Boost {value}x",
        active: "Actif",
        archived: "Archivé",
        excellent: "Excellent",
        good: "Bien",
        ...
        share_progress: "Partager la progression",
        ...
        ach_zero_miss_day: "Jour sans erreur",
        ...
        ach_one_year_strong: "Un an de force'un an",
        ach_one_year_strong_desc: "Restez actif pendant 365 jours.",
        ach_century_streak: "Série Centenaire",
        ...
        ach_tobedone_legend: "Légende Tobedone",
    ...
    multiplier: "Boost {value}x",
        ...
        tasks_subtitle: "Vos tâches actives",
        ...
        november: "Novembre",
        december: "Décembre",
        rec_lvl10_title: "🏆 Niveau 10 Atteint",
        rec_lvl10_desc: "Atteignez le Niveau 10",
        rec_streak7_title: "🔥 Série de 7 Jours",
        rec_streak7_desc: "Série de 7 jours",
        rec_streak30_title: "🔥 Série de 30 Jours",
        rec_streak30_desc: "Série de 30 jours",
        rec_goal_title: "🎯 Maître des Objectifs",
        rec_goal_desc: "Complétez 10 objectifs",
        rec_elite_title: "⭐ Statut Élite",
        rec_elite_desc: "Atteignez le Rang : Élite",
        rec_habit_title: "📅 Bâtisseur d'Habitudes",
        rec_habit_desc: "Créez 5 habitudes",
        chal_tasks_title: "Complétez 5 tâches",
        chal_tasks_desc: "Repoussez vos limites",
        chal_streak_title: "Atteignez une série de 3 jours",
        chal_streak_desc: "La constance est la clé",
        future_placeholder: "Écrivez une lettre...",
        future_dear: "Cher moi...",
        loading: "Chargement...",
        ...
        achieved_failed: "Atteint / Échoué",
        achieved: "Atteint",
        failed_status: "Échoué",
        longest_streak: "Plus longue série",
        highest_xp: "XP max",
        max_tasks_day: "Max tâches par jour",
        tasks_word: "Tâches",
        goals_word: "Objectifs",
        ms_first_step: "Premier Pas",
        ms_first_step_desc: "Complétez votre 1ère tâche",
        ms_goal_setter: "Fixateur d'Objectifs'Objectifs",
        ms_goal_setter_desc: "Fixez votre 1er objectif",
        ms_lvl10: "Niveau 10",
        ms_lvl10_desc: "Atteignez le Niveau 10",
        ms_trust_builder: "Bâtisseur de Confiance",
        ms_trust_builder_desc: "Confiance > 50",
        ms_discipline_elite: "Élite de Discipline",
        ms_discipline_elite_desc: "Atteignez le Niveau 25",
        ms_legendary: "Légendaire",
        ms_legendary_desc: "100 tâches, niveau 50",
        locked: "Verrouillé",
        unlocked_status: "Déverrouillé",
        weekly_perf_card: "Performances hebdo",
        weekly_perf_desc: "Statistiques d'activité hebdomadaires générées automatiquement",
        monthly_perf_card: "Performances mensuelles",
        monthly_perf_desc: "Examen détaillé des performances mensuelles",
        weekly_progress_tab: "Progrès Hebdo",
        tasks_done: "Tâches",
        goals_done: "Objectifs",
        streak_health: "Santé de la Série",
        trust_growth: "Croissance de Confiance",
        xp_rank_level: "Niveau XP",
        trust_consistency: "Constance de Confiance",
        chal_summer_sprint: "Sprint d'Été",
        chal_summer_desc: "Complétez 10 tâches pour un boost.",
        chal_30day: "Constance de 30 Jours",
        ...
        ready: "Prêt",
        opened: "Ouvert",
        no_messages_yet: "Aucun message. Écrivez le premier !",
        ready_to_open: "Prêt à ouvrir !",
        fs_promise: "🤝 Promesse",
        fs_prediction: "🔮 Prédiction",
        fs_reminder: "🔔 Rappel",
        fs_motivational: "💪 Motivation",
        no_achievements: "Aucun succès",
        for_you_default_body: "Continuez vos tâches",
        profile_updated: "Profil mis à jour",
        profile_update_failed: "Échec de la mise à jour",
        profile_link_copied: "Lien copié",
        insight_start_streak: "Commencez la Série",
        insight_start_streak_body: "Complétez quelque chose",
        levels_to_rank: "Niveaux pour Rank Up",
        reach_level: "Atteindre le Niveau",
        to_unlock: "pour débloquer",
        rank_push: "Continuez !",
        tasks_to_milestone: "Tâches avant Palier",
        complete: "Terminer",
        more_tasks_milestone: "tâches en plus pour",
        ...
        completed_tasks_total: "Total terminé",
        completed_tasks_today: "Terminé aujourd'hui",
        completed_tasks_this_week: "Cette semaine",
        completed_tasks_this_month: "Ce mois-ci",
    ...
    de: {
        ...
        smart_insights: "Smarte Einblicke",
        ...
        ach_zero_miss_day: "Fehlerfreier Tag",
        ...
        ach_century_streak: "Hundert-Tage-Strähne",
        ...
        tasks_subtitle: "Deine aktiven Aufgaben",
        ...
        november: "November",
        december: "Dezember",
        rec_lvl10_title: "🏆 Level 10 Erreicht",
        rec_lvl10_desc: "Erreiche Level 10",
        rec_streak7_title: "🔥 7-Tage-Strähne",
        rec_streak7_desc: "Halte eine 7-Tage-Strähne",
        rec_streak30_title: "🔥 30-Tage-Strähne",
        rec_streak30_desc: "Halte eine 30-Tage-Strähne",
        rec_goal_title: "🎯 Ziel-Meister",
        rec_goal_desc: "10 Ziele abgeschlossen",
        rec_elite_title: "⭐ Elite-Status",
        rec_elite_desc: "Erreiche Rang: Elite",
        rec_habit_title: "📅 Gewohnheits-Bauer",
        rec_habit_desc: "5 Gewohnheiten erstellt",
        chal_tasks_title: "Erledige 5 Aufgaben",
        chal_tasks_desc: "Geh an deine Grenzen",
        chal_streak_title: "Erreiche eine 3-Tage-Strähne",
        chal_streak_desc: "Konsistenz ist der Schlüssel",
        future_placeholder: "Schreibe einen Brief...",
        future_dear: "Liebes zukünftiges Ich...",
        loading: "Laden...",
        ...
        achieved_failed: "Erreicht / Fehlgeschlagen",
        achieved: "Erreicht",
        ...
        ms_first_step_desc: "Erste Aufgabe erledigt",
        ms_goal_setter: "Zielsetzer",
        ms_goal_setter_desc: "Erstes Ziel gesetzt",
        ms_lvl10: "Level 10",
        ms_lvl10_desc: "Erreiche Level 10",
        ms_trust_builder: "Vertrauensbauer",
        ms_trust_builder_desc: "Vertrauen über 50",
        ms_discipline_elite: "Disziplin-Elite",
        ms_discipline_elite_desc: "Erreiche Level 25",
        ms_legendary: "Legendär",
        ms_legendary_desc: "100 Aufgaben, Level 50",
        locked: "Gesperrt",
        unlocked_status: "Freigeschaltet",
        weekly_perf_card: "Wöchentliche Leistung",
        weekly_perf_desc: "Automatisch generierte wöchentliche Aktivitätsstatistiken",
        monthly_perf_card: "Monatliche Leistung",
        monthly_perf_desc: "Detaillierte monatliche Leistungsüberprüfung",
        weekly_progress_tab: "Wöchentlicher Fortschritt",
        tasks_done: "Aufgaben",
        goals_done: "Ziele",
        streak_health: "Strähnen-Gesundheit",
        trust_growth: "Vertrauens-Wachstum",
        xp_rank_level: "XP Level",
        trust_consistency: "Vertrauens-Konsistenz",
        chal_summer_sprint: "Sommer-Sprint",
        chal_summer_desc: "10 Aufgaben für massiven Boost.",
        chal_30day: "30 Tage Konsistenz",
        chal_30day_desc: "Halte eine 30-Tage-Strähne.",
        ...
        ready: "Bereit",
        opened: "Geöffnet",
        no_messages_yet: "Keine Nachrichten. Schreib die erste!",
        ...
        for_you_default_body: "Erledige weiter Aufgaben",
        profile_updated: "Profil aktualisiert",
        profile_update_failed: "Profilaktualisierung fehlgeschlagen",
        profile_link_copied: "Link kopiert",
        insight_start_streak: "Strähne starten",
        insight_start_streak_body: "Schließe etwas ab",
        levels_to_rank: "Level bis Aufstieg",
        reach_level: "Erreiche Level",
        to_unlock: "zum Freischalten",
        rank_push: "Weiter so!",
        tasks_to_milestone: "Aufgaben bis Meilenstein",
        complete: "Abschließen",
        more_tasks_milestone: "weitere Aufgaben für",
        ...
        completed_tasks_total: "Gesamt abgeschlossen",
        completed_tasks_today: "Heute abgeschlossen",
        completed_tasks_this_week: "Diese Woche",
        completed_tasks_this_month: "Diesen Monat",
        task_statistics: "Aufgabenstatistik",
    },
    it: {
        app_title: "Tobedone",
        ...
        well_done: "Ben fatto!", keep_going: "Continua così!", streak_saved: "Serie mantenuta!", multiplier: "Potenziamento {value}x",
        active: "Attivo",
        archived: "Archiviato",
        ...
        notif_level_up: "Livello Superato",
        ...
        smart_insights: "Statistiche Intelligenti",
        ...
        share_progress: "Condividi Progresso",
        download: "Scarica",
        ...
        ach_zero_miss_day: "Giorno senza errori",
        ...
        ach_century_streak: "Serie Centenaria",
        ...
        ach_tobedone_legend: "Leggenda Tobedone",
        ...
        level_up: "Livello Superato",
        multiplier: "Potenziamento {value}x",
        ...
        november: "Novembre",
        december: "Dicembre",
        rec_lvl10_title: "🏆 Livello 10 Raggiunto",
        rec_lvl10_desc: "Raggiungi il Livello 10",
        rec_streak7_title: "🔥 Serie di 7 Giorni",
        rec_streak7_desc: "Mantieni serie di 7 giorni",
        rec_streak30_title: "🔥 Serie di 30 Giorni",
        rec_streak30_desc: "Mantieni serie di 30 giorni",
        rec_goal_title: "🎯 Maestro di Obiettivi",
        rec_goal_desc: "Completa 10 obiettivi",
        rec_elite_title: "⭐ Stato Élite",
        rec_elite_desc: "Raggiungi il Rango: Élite",
        rec_habit_title: "📅 Costruttore di Abitudini",
        rec_habit_desc: "Crea 5 abitudini",
        chal_tasks_title: "Completa 5 attività",
        chal_tasks_desc: "Supera i tuoi limiti",
        chal_streak_title: "Raggiungi una serie di 3 giorni",
        chal_streak_desc: "La costanza è fondamentale",
        future_placeholder: "Scrivi una lettera...",
        future_dear: "Caro me...",
        loading: "Caricamento...",
        ...
        achieved_failed: "Raggiunto / Fallito",
        achieved: "Raggiunto",
        failed_status: "Fallito",
        longest_streak: "Serie più lunga",
        highest_xp: "XP Massimo",
        max_tasks_day: "Max attività/giorno",
        tasks_word: "Attività",
        goals_word: "Obiettivi",
        ms_first_step: "Primo Passo",
        ms_first_step_desc: "Completa la tua prima attività",
        ms_goal_setter: "Pianificatore",
        ms_goal_setter_desc: "Imposta il tuo primo obiettivo",
        ms_lvl10: "Livello 10",
        ms_lvl10_desc: "Raggiungi il Livello 10",
        ms_trust_builder: "Costruttore di Fiducia",
        ms_trust_builder_desc: "Fiducia sopra 50",
        ms_discipline_elite: "Élite Disciplina",
        ms_discipline_elite_desc: "Raggiungi Livello 25",
        ms_legendary: "Leggendario",
        ms_legendary_desc: "100 attività, livello 50",
        locked: "Bloccato",
        unlocked_status: "Sbloccato",
        weekly_perf_card: "Performance Settimanale",
        weekly_perf_desc: "Statistiche di attività settimanali generate automaticamente",
        monthly_perf_card: "Performance Mensile",
        monthly_perf_desc: "Revisione dettagliata delle metriche di performance mensili",
        weekly_progress_tab: "Progresso Settimanale",
        tasks_done: "Attività",
        goals_done: "Obiettivi",
        streak_health: "Salute Serie",
        trust_growth: "Crescita Fiducia",
        xp_rank_level: "Livello XP",
        trust_consistency: "Costanza Fiducia",
        chal_summer_sprint: "Sprint Estivo",
        chal_summer_desc: "Completa 10 attività per un bonus.",
        chal_30day: "Costanza di 30 Giorni",
        chal_30day_desc: "Mantieni una serie di 30 giorni.",
        ...
        ready: "Pronto",
        opened: "Aperto",
        no_messages_yet: "Nessun messaggio. Scrivi il primo!",
        ready_to_open: "Pronto per l'apertura!'apertura!",
        fs_promise: "🤝 Promessa",
        fs_prediction: "🔮 Previsione",
        fs_reminder: "🔔 Promemoria",
        fs_motivational: "💪 Motivazionale",
        no_achievements: "Nessun obiettivo",
        for_you_default_body: "Continua con le attività",
        profile_updated: "Profilo aggiornato",
        profile_update_failed: "Errore aggiornamento",
        profile_link_copied: "Link copiato",
        insight_start_streak: "Inizia la Serie",
        insight_start_streak_body: "Completa qualcosa",
        levels_to_rank: "Livelli al prossimo Rank",
        reach_level: "Raggiungi il Livello",
        to_unlock: "per sbloccare",
        rank_push: "Forza!",
        tasks_to_milestone: "Attività al Traguardo",
        complete: "Completa",
        more_tasks_milestone: "attività in più per",
        ...
        average: "Medio",
        xp_boost: "Potenziamento XP",
        tasks_subtitle: "Le tue attività",
        ...
        completed_tasks_total: "Totale completato",
        completed_tasks_today: "Completato oggi",
        completed_tasks_this_week: "Questa settimana",
        completed_tasks_this_month: "Questo mese",
    ...
    pt: {
        ...
        well_done: "Muito bem!", keep_going: "Continue!", streak_saved: "Sequência mantida!", multiplier: "Impulso {value}x",
        active: "Ativo",
        archived: "Arquivado",
        excellent: "Excelente",
        good: "Bom",
        ...
        ach_zero_miss_day: "Dia sem erros",
        ...
        ach_century_streak: "Sequência Centenária",
        ...
        ach_tobedone_legend: "Lenda Tobedone",
        ...
        november: "Novembro",
        december: "Dezembro",
        rec_lvl10_title: "🏆 Nível 10 Alcançado",
        rec_lvl10_desc: "Alcance o Nível 10",
        rec_streak7_title: "🔥 Sequência de 7 Dias",
        rec_streak7_desc: "Mantenha sequência de 7 dias",
        rec_streak30_title: "🔥 Sequência de 30 Dias",
        rec_streak30_desc: "Mantenha sequência de 30 dias",
        rec_goal_title: "🎯 Mestre de Objetivos",
        rec_goal_desc: "Conclua 10 objetivos",
        rec_elite_title: "⭐ Status de Elite",
        rec_elite_desc: "Alcance o Rank: Elite",
        rec_habit_title: "📅 Construtor de Hábitos",
        rec_habit_desc: "Crie 5 hábitos",
        chal_tasks_title: "Conclua 5 tarefas",
        chal_tasks_desc: "Supere seus limites",
        chal_streak_title: "Alcance uma sequência de 3 dias",
        chal_streak_desc: "A consistência é a chave",
        future_placeholder: "Escreva uma carta...",
        future_dear: "Querido eu...",
        loading: "Carregando...",
        ...
        achieved_failed: "Alcançado / Falhou",
        achieved: "Alcançado",
        failed_status: "Falhou",
        longest_streak: "Sequência mais longa",
        highest_xp: "Maior XP",
        max_tasks_day: "Max tarefas/dia",
        tasks_word: "Tarefas",
        goals_word: "Metas",
        ms_first_step: "Primeiro Passo",
        ms_first_step_desc: "Conclua sua primeira tarefa",
        ms_goal_setter: "Criador de Objetivos",
        ms_goal_setter_desc: "Defina seu primeiro objetivo",
        ms_lvl10: "Nível 10",
        ms_lvl10_desc: "Alcance o Nível 10",
        ms_trust_builder: "Construtor de Confiança",
        ms_trust_builder_desc: "Confiança acima de 50",
        ms_discipline_elite: "Elite de Disciplina",
        ms_discipline_elite_desc: "Alcance o Nível 25",
        ms_legendary: "Lendário",
        ms_legendary_desc: "100 tarefas, nível 50",
        locked: "Bloqueado",
        unlocked_status: "Desbloqueado",
        weekly_perf_card: "Desempenho Semanal",
        weekly_perf_desc: "Estatísticas de atividades semanais geradas automaticamente",
        monthly_perf_card: "Desempenho Mensal",
        monthly_perf_desc: "Revisão detalhada de métricas de desempenho mensal",
        weekly_progress_tab: "Progresso Semanal",
        tasks_done: "Tarefas",
        goals_done: "Objetivos",
        streak_health: "Saúde da Sequência",
        trust_growth: "Crescimento de Confiança",
        xp_rank_level: "Nível XP",
        trust_consistency: "Consistência de Confiança",
        chal_summer_sprint: "Sprint de Verão",
        chal_summer_desc: "Conclua 10 tarefas para um impulso.",
        chal_30day: "Consistência de 30 Dias",
        chal_30day_desc: "Mantenha uma sequência de 30 dias.",
        in_progress: "Progresso",
        xp_reward_500: "+500 XP",
        xp_reward_1500: "+1500 XP",
        sent: "Enviado",
        ready: "Pronto",
        opened: "Aberto",
        no_messages_yet: "Nenhuma mensagem. Escreva a primeira!",
        ready_to_open: "Pronto para abrir!",
        fs_promise: "🤝 Promessa",
        fs_prediction: "🔮 Previsão",
        fs_reminder: "🔔 Lembrete",
        fs_motivational: "💪 Motivação",
        no_achievements: "Sem conquistas",
        for_you_default_body: "Continue concluindo tarefas",
        profile_updated: "Perfil atualizado",
        profile_update_failed: "Falha ao atualizar perfil",
        profile_link_copied: "Link copiado",
        insight_start_streak: "Inicie a Sequência",
        insight_start_streak_body: "Conclua algo",
        levels_to_rank: "Níveis para Subir",
        reach_level: "Alcance o Nível",
        to_unlock: "para desbloquear",
        rank_push: "Continue!",
        tasks_to_milestone: "Tarefas para Marco",
        complete: "Completar",
        more_tasks_milestone: "mais tarefas para",
        ...
        completed_tasks_total: "Total concluído",
        completed_tasks_today: "Concluído hoje",
        completed_tasks_this_week: "Esta semana",
        completed_tasks_this_month: "Este mês",
    ...
    ru: {
        ...
        smart_insights: "Умная статистика",
        ...
        ach_zero_miss_day: "День без промахов",
        ...
        ach_comeback_king: "Король возвращений",
        ...
        ach_one_year_strong: "Один год силы",
        ach_one_year_strong_desc: "Оставайтесь активными в течение 365 дней.",
        ach_century_streak: "Вековая серия",
        ...
        ach_tobedone_legend: "Легенда Tobedone",
        ...
        goals: "Цели", habits: "Привычки", goals_tab: "Цели", habits_tab: "Привычки", add_goal: "Добавить Цель", add_habit: "Добавить Привычку", new_goal: "Новая Цель", new_habit: "Новая Привычка", today_habits: "Привычки на Сегодня", goals_subtitle: "Вехи на будущее.", habits_subtitle: "Маленькие шаги, большие результаты.", reflect: "Рефлексия", reflection: "Рефлексия", check_in: "Чекин", save_goal: "Сохранить Цель", save_habit: "Сохранить Привычку",
        profile: "Профиль",
        for_you: "Для вас",
        ...
        november: "Ноябрь",
        december: "Декабрь",
        rec_lvl10_title: "🏆 Уровень 10 достигнут",
        rec_lvl10_desc: "Достигни 10 уровня",
        rec_streak7_title: "🔥 7-дневная серия",
        rec_streak7_desc: "Поддерживай серию 7 дней",
        rec_streak30_title: "🔥 30-дневная серия",
        rec_streak30_desc: "Поддерживай серию 30 дней",
        rec_goal_title: "🎯 Мастер целей",
        rec_goal_desc: "Завершите 10 целей",
        rec_elite_title: "⭐ Элитный статус",
        rec_elite_desc: "Достигни ранга: Элита",
        rec_habit_title: "📅 Создатель привычек",
        rec_habit_desc: "Создайте 5 привычек",
        chal_tasks_title: "Выполните 5 задач",
        chal_tasks_desc: "Превзойдите свои пределы",
        chal_streak_title: "Достигни серии в 3 дня",
        chal_streak_desc: "Постоянство - ключ к успеху",
        future_placeholder: "Напишите письмо...",
        future_dear: "Дорогой я...",
        loading: "Загрузка...",
        ...
        achieved_failed: "Достигнуто / Провалено",
        achieved: "Достигнуто",
        failed_status: "Провалено",
        longest_streak: "Лучшая серия",
        highest_xp: "Максимальный XP",
        max_tasks_day: "Макс задач в день",
        tasks_word: "Задачи",
        goals_word: "Цели",
        ms_first_step: "Первый шаг",
        ms_first_step_desc: "Завершите свою первую задачу",
        ms_goal_setter: "Постановщик целей",
        ms_goal_setter_desc: "Поставьте свою первую цель",
        ms_lvl10: "10 уровень",
        ms_lvl10_desc: "Достигни 10 уровня",
        ms_trust_builder: "Строитель доверия",
        ms_trust_builder_desc: "Доверие выше 50",
        ms_discipline_elite: "Элита дисциплины",
        ms_discipline_elite_desc: "Достигни 25 уровня",
        ms_legendary: "Легендарный",
        ms_legendary_desc: "100 задач, 50 уровень",
        locked: "Заблокировано",
        unlocked_status: "Разблокировано",
        weekly_perf_card: "Недельная успеваемость",
        weekly_perf_desc: "Автоматически сгенерированная еженедельная статистика активности",
        monthly_perf_card: "Месячная успеваемость",
        monthly_perf_desc: "Подробный обзор ежемесячных показателей производительности",
        weekly_progress_tab: "Недельный прогресс",
        tasks_done: "Задачи",
        goals_done: "Цели",
        streak_health: "Здоровье серии",
        trust_growth: "Рост доверия",
        xp_rank_level: "Уровень XP",
        trust_consistency: "Постоянство доверия",
        chal_summer_sprint: "Летний спринт",
        chal_summer_desc: "Завершите 10 задач для буста.",
        chal_30day: "30 дней постоянства",
        chal_30day_desc: "Поддерживайте серию 30 дней.",
        ...
        ready: "Готово",
        opened: "Открыто",
        no_messages_yet: "Нет сообщений. Напишите первое!",
        ready_to_open: "Готово к открытию!",
        fs_promise: "🤝 Обещание",
        fs_prediction: "🔮 Предсказание",
        fs_reminder: "🔔 Напоминание",
        fs_motivational: "💪 Мотивация",
        no_achievements: "Нет достижений",
        for_you_default_body: "Продолжайте выполнять задачи",
        profile_updated: "Профиль обновлен",
        profile_update_failed: "Ошибка обновления",
        profile_link_copied: "Ссылка скопирована",
        insight_start_streak: "Начать серию",
        insight_start_streak_body: "Завершите задачу",
        levels_to_rank: "Уровней до ранга",
        reach_level: "Достигни уровня",
        to_unlock: "чтобы открыть",
        rank_push: "Продолжай!",
        tasks_to_milestone: "Задач до вехи",
        complete: "Завершить",
        more_tasks_milestone: "задач до",
        ...
        completed_tasks_total: "Всего выполнено",
        completed_tasks_today: "Выполнено сегодня",
        completed_tasks_this_week: "На этой неделе",
        completed_tasks_this_month: "В этом месяце",
    ...
    ja: {
        ...
        well_done: "よくできました！", keep_going: "その調子！", streak_saved: "連続達成維持！", multiplier: "{value}倍ブースト",
        active: "アクティブ",
        archived: "アーカイブ済み",
        excellent: "素晴らしい",
        good: "良い",
        ...
        ach_tobedone_legend: "Tobedoneの伝説",
        ...
        november: "11月",
        december: "12月",
        rec_lvl10_title: "🏆 レベル10達成",
        rec_lvl10_desc: "レベル10に到達",
        rec_streak7_title: "🔥 7日間ストリーク",
        rec_streak7_desc: "7日間のストリークを維持",
        rec_streak30_title: "🔥 30日間ストリーク",
        rec_streak30_desc: "30日間のストリークを維持",
        rec_goal_title: "🎯 目標マスター",
        rec_goal_desc: "10個の目標を完了",
        rec_elite_title: "⭐ エリートステータス",
        rec_elite_desc: "ランク：エリートに到達",
        rec_habit_title: "📅 習慣ビルダー",
        rec_habit_desc: "5つの習慣を作成",
        chal_tasks_title: "5つのタスクを完了",
        chal_tasks_desc: "限界に挑戦",
        chal_streak_title: "3日間のストリークを達成",
        chal_streak_desc: "継続は力なり",
        future_placeholder: "未来の自分への手紙を書く",
        future_dear: "未来の私へ...",
        loading: "読み込み中...",
        consistency: "一貫性",
        opens_in: "後に開封",
        ...
        achieved_failed: "達成 / 失敗",
        achieved: "達成",
        failed_status: "失敗",
        longest_streak: "最長ストリーク",
        highest_xp: "最高XP",
        max_tasks_day: "1日の最大タスク数",
        tasks_word: "タスク",
        goals_word: "目標",
        ms_first_step: "第一歩",
        ms_first_step_desc: "最初のタスクを完了",
        ms_goal_setter: "目標設定者",
        ms_goal_setter_desc: "最初の目標を設定",
        ms_lvl10: "レベル10",
        ms_lvl10_desc: "レベル10に到達",
        ms_trust_builder: "信頼構築者",
        ms_trust_builder_desc: "信頼を50以上にする",
        ms_discipline_elite: "規律のエリート",
        ms_discipline_elite_desc: "レベル25に到達",
        ms_legendary: "伝説的",
        ms_legendary_desc: "100個のタスク、レベル50",
        locked: "ロック",
        unlocked_status: "アンロック",
        weekly_perf_card: "週次パフォーマンス",
        weekly_perf_desc: "自動生成された週次アクティビティ統計",
        monthly_perf_card: "月次パフォーマンス",
        monthly_perf_desc: "詳細な月次パフォーマンス指標のレビュー",
        weekly_progress_tab: "週次進捗",
        tasks_done: "完了したタスク",
        goals_done: "達成した目標",
        streak_health: "ストリークの健康",
        trust_growth: "信頼の成長",
        xp_rank_level: "XPランクレベル",
        trust_consistency: "信頼の一貫性",
        chal_summer_sprint: "サマースプリント",
        chal_summer_desc: "10個のタスクを完了してブーストを獲得",
        chal_30day: "30日間継続",
        chal_30day_desc: "30日間のストリークを維持する。",
        in_progress: "進捗",
        xp_reward_500: "+500 XP",
        xp_reward_1500: "+1500 XP",
        sent: "送信済み",
        ready: "準備完了",
        opened: "開封済み",
        no_messages_yet: "まだメッセージはありません。最初に書き込みましょう！",
        ready_to_open: "開く準備ができました！",
        fs_promise: "🤝 約束",
        fs_prediction: "🔮 予測",
        fs_reminder: "🔔 リマインダー",
        fs_motivational: "💪 モチベーション",
        no_achievements: "まだ実績がありません",
        for_you_default_body: "タスクを完了してガイダンスをアンロック",
        profile_updated: "プロフィールが更新されました",
        profile_update_failed: "プロフィールの更新に失敗しました",
        profile_link_copied: "リンクをコピーしました",
        insight_start_streak: "ストリーク開始",
        insight_start_streak_body: "タスクを完了してストリークを開始",
        levels_to_rank: "ランクアップまで",
        reach_level: "レベル到達",
        to_unlock: "アンロックするため",
        rank_push: "頑張って！",
        tasks_to_milestone: "マイルストーンまで",
        complete: "完了",
        more_tasks_milestone: "目標までの残りタスク",
        create_task: "タスク作成",
        create_goal: "目標作成",
        create_habit: "習慣作成",
        ...
        completed_tasks_total: "合計完了",
        completed_tasks_today: "今日完了",
        completed_tasks_this_week: "今週",
        completed_tasks_this_month: "今月",
        task_statistics: "タスク統計",
    },
    zh: {
        app_title: "托贝多内",
        ...
        well_done: "干得好！", keep_going: "继续保持！", streak_saved: "连续未断！", multiplier: "{value}倍 加成",
        active: "积极的",
        archived: "已存档",
        excellent: "优秀",
        good: "好的",
        ...
        ach_one_year_strong: "坚持一年",
        ach_one_year_strong_desc: "365 天保持活跃。",
        ach_century_streak: "百年连胜",
        ...
        ach_tobedone_legend: "Tobedone 传奇",
    ...
    multiplier: "{value}倍 加成",
        ...
        goals: "目标", habits: "习惯", goals_tab: "目标", habits_tab: "习惯", add_goal: "添加目标", add_habit: "添加习惯", new_goal: "新目标", new_habit: "新习惯", today_habits: "今日习惯", goals_subtitle: "未来的里程碑。", habits_subtitle: "每天一小步，成就一大步。", reflect: "反思", reflection: "反思", check_in: "签到", save_goal: "保存目标", save_habit: "保存习惯",
        profile: "个人资料",
        for_you: "为你推荐",
        save_changes: "保存更改",
        category_general: "常规",
        ...
        november: "十一月",
        december: "十二月",
        rec_lvl10_title: "🏆 达到10级",
        rec_lvl10_desc: "达到10级个人生产力",
        rec_streak7_title: "🔥 7天连胜",
        rec_streak7_desc: "保持7天连胜",
        rec_streak30_title: "🔥 30天连胜",
        rec_streak30_desc: "保持30天连胜",
        rec_goal_title: "🎯 目标大师",
        rec_goal_desc: "完成10个目标",
        rec_elite_title: "⭐ 精英状态",
        rec_elite_desc: "达到等级：精英",
        rec_habit_title: "📅 习惯培养者",
        rec_habit_desc: "创建5个习惯",
        chal_tasks_title: "今天完成5项任务",
        chal_tasks_desc: "突破你的极限",
        chal_streak_title: "达到3天连胜",
        chal_streak_desc: "坚持是关键",
        future_placeholder: "写一封信给未来的自己",
        future_dear: "亲爱的未来的自己...",
        loading: "加载中...",
        consistency: "一致性",
        opens_in: "将在",
        open_message: "打开消息",
        ...
        achieved_failed: "已实现 / 失败",
        achieved: "已实现",
        failed_status: "失败",
        longest_streak: "最长连续记录",
        highest_xp: "最高 XP",
        max_tasks_day: "单日最多任务",
        tasks_word: "任务",
        goals_word: "目标",
        ms_first_step: "第一步",
        ms_first_step_desc: "完成你的第一个任务",
        ms_goal_setter: "目标制定者",
        ms_goal_setter_desc: "设定你的第一个目标",
        ms_lvl10: "达到10级",
        ms_lvl10_desc: "达到10级个人生产力",
        ms_trust_builder: "信任建设者",
        ms_trust_builder_desc: "将自我信任分提高到50以上",
        ms_discipline_elite: "纪律精英",
        ms_discipline_elite_desc: "达到25级",
        ms_legendary: "传奇成就者",
        ms_legendary_desc: "完成100个任务并达到50级",
        locked: "已锁定",
        unlocked_status: "已解锁",
        weekly_perf_card: "每周表现卡",
        weekly_perf_desc: "自动生成的每周活动统计数据",
        monthly_perf_card: "每月表现卡",
        monthly_perf_desc: "详细的月度绩效指标审查",
        weekly_progress_tab: "每周进度",
        tasks_done: "已完成任务",
        goals_done: "已实现目标",
        streak_health: "连胜健康度",
        trust_growth: "信任增长",
        xp_rank_level: "XP 排名等级",
        trust_consistency: "信任一致性",
        chal_summer_sprint: "夏季冲刺",
        chal_summer_desc: "完成10项任务以获得巨大加成。",
        chal_30day: "30天坚持",
        chal_30day_desc: "保持 30 天连胜。",
        in_progress: "进度",
        xp_reward_500: "+500 XP",
        xp_reward_1500: "+1500 XP",
        sent: "已发送",
        ready: "就绪",
        opened: "已打开",
        no_messages_yet: "暂无消息。在上面写下你的第一条消息！",
        ready_to_open: "准备开启！",
        fs_promise: "🤝 承诺",
        fs_prediction: "🔮 预测",
        fs_reminder: "🔔 提醒",
        ...
        for_you_default_body: "继续完成任务以解锁个性化指导",
        profile_updated: "个人资料已更新",
        profile_update_failed: "个人资料更新失败",
        profile_link_copied: "链接已复制",
        insight_start_streak: "开始连续记录",
        insight_start_streak_body: "完成一项任务以开始连续记录",
        levels_to_rank: "升级所需等级",
        reach_level: "达到等级",
        to_unlock: "解锁",
        rank_push: "继续努力！",
        tasks_to_milestone: "距里程碑的任务数",
        complete: "完成",
        more_tasks_milestone: "还需任务数即可达到里程碑",
        create_task: "创建任务",
        create_goal: "创建目标",
        create_habit: "创建习惯",
        pressure_low: "低压力",
        ...
        completed_tasks_total: "总计完成",
        completed_tasks_today: "今日完成",
        completed_tasks_this_week: "本周",
        completed_tasks_this_month: "本月",
    ...
    ar: {
        ...
        well_done: "أحسنت!", keep_going: "استمر!", streak_saved: "تم الحفاظ على السلسلة!", multiplier: "تعزيز {value}x",
        active: "نشيط",
        archived: "مؤرشف",
        excellent: "ممتاز",
        good: "جيد",
        ...
        ach_zero_miss_day: "يوم بدون أخطاء",
        ...
        ach_one_year_strong: "عام من القوة",
        ach_one_year_strong_desc: "تظل نشطة لمدة 365 يومًا.",
        ach_century_streak: "سلسلة المئة",
        ...
        ach_tobedone_legend: "أسطورة توبدون",
        ...
        goals: "أهداف", habits: "عادات", goals_tab: "أهداف", habits_tab: "عادات", add_goal: "إضافة هدف", add_habit: "إضافة عادة", new_goal: "هدف جديد", new_habit: "عادة جديدة", today_habits: "عادات اليوم", goals_subtitle: "معالم للمستقبل.", habits_subtitle: "خطوات صغيرة، نتائج كبيرة.", reflect: "تأمل", reflection: "تأمل", check_in: "تسجيل الدخول", save_goal: "حفظ الهدف", save_habit: "حفظ العادة",
        ...
        november: "نوفمبر",
        december: "ديسمبر",
        rec_lvl10_title: "🏆 تم الوصول للمستوى 10",
        rec_lvl10_desc: "الوصول إلى المستوى 10",
        rec_streak7_title: "🔥 سلسلة 7 أيام",
        rec_streak7_desc: "حافظ على سلسلة من 7 أيام",
        rec_streak30_title: "🔥 سلسلة 30 يوم",
        rec_streak30_desc: "حافظ على سلسلة من 30 يومًا",
        rec_goal_title: "🎯 سيد الأهداف",
        rec_goal_desc: "أكمل 10 أهداف",
        rec_elite_title: "⭐ حالة النخبة",
        rec_elite_desc: "الوصول إلى الرتبة: نخبة",
        rec_habit_title: "📅 باني العادات",
        rec_habit_desc: "قم بإنشاء 5 عادات",
        chal_tasks_title: "أكمل 5 مهام اليوم",
        chal_tasks_desc: "ادفع حدودك",
        chal_streak_title: "الوصول إلى سلسلة من 3 أيام",
        chal_streak_desc: "الاتساق هو المفتاح",
        future_placeholder: "اكتب رسالة...",
        future_dear: "عزيزي أنا المستقبل...",
        ...
        achieved_failed: "تحقق / فشل",
        achieved: "تم تحقيقه",
        failed_status: "فشل",
        longest_streak: "أطول سلسلة",
        highest_xp: "أعلى خبرة",
        max_tasks_day: "أقصى مهام في اليوم",
        tasks_word: "المهام",
        goals_word: "الأهداف",
        ms_first_step: "الخطوة الأولى",
        ms_first_step_desc: "أكمل مهمتك الأولى",
        ms_goal_setter: "محدد الأهداف",
        ms_goal_setter_desc: "حدد هدفك الأول",
        ms_lvl10: "المستوى 10",
        ms_lvl10_desc: "الوصول إلى المستوى 10",
        ms_trust_builder: "باني الثقة",
        ms_trust_builder_desc: "ارفع الثقة إلى أكثر من 50",
        ms_discipline_elite: "نخبة الانضباط",
        ms_discipline_elite_desc: "الوصول إلى المستوى 25",
        ms_legendary: "أسطوري",
        ms_legendary_desc: "100 مهمة ومستوى 50",
        locked: "مغلق",
        unlocked_status: "مفتوح",
        weekly_perf_card: "الأداء الأسبوعي",
        weekly_perf_desc: "إحصاءات النشاط الأسبوعي التي تم إنشاؤها تلقائيًا",
        monthly_perf_card: "الأداء الشهري",
        monthly_perf_desc: "مراجعة مفصلة لمقاييس الأداء الشهري",
        weekly_progress_tab: "التقدم الأسبوعي",
        tasks_done: "المهام المنجزة",
        goals_done: "الأهداف المنجزة",
        streak_health: "صحة السلسلة",
        trust_growth: "نمو الثقة",
        xp_rank_level: "مستوى XP",
        trust_consistency: "اتساق الثقة",
        chal_summer_sprint: "سباق الصيف",
        chal_summer_desc: "أكمل 10 مهام للحصول على تعزيز كبير.",
        chal_30day: "30 يوم من الاتساق",
        chal_30day_desc: "حافظ على سلسلة من 30 يومًا.",
        in_progress: "التقدم",
        xp_reward_500: "+500 XP",
        xp_reward_1500: "+1500 XP",
        sent: "تم الإرسال",
        ready: "جاهز",
        opened: "مفتوح",
        no_messages_yet: "لا توجد رسائل. اكتب رسالتك الأولى!",
        ready_to_open: "جاهز للفتح!",
        fs_promise: "🤝 وعد",
        fs_prediction: "🔮 توقع",
        fs_reminder: "🔔 تذكير",
        fs_motivational: "💪 تحفيز",
        no_achievements: "لا توجد إنجازات",
        for_you_default_body: "استمر في المهام",
        profile_updated: "تم تحديث الملف الشخصي",
        profile_update_failed: "فشل تحديث الملف الشخصي",
        profile_link_copied: "تم نسخ الرابط",
        insight_start_streak: "ابدأ السلسلة",
        insight_start_streak_body: "أكمل مهمة",
        levels_to_rank: "مستويات للترقية",
        reach_level: "صل إلى المستوى",
        to_unlock: "لفتح",
        rank_push: "استمر!",
        tasks_to_milestone: "المهام للمعلم",
        complete: "إكمال",
        more_tasks_milestone: "مزيد من المهام ل",
