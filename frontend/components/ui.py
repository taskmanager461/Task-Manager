...
def hero_metrics(score_value: str, score_label: str,
    ...
    def get_bg_style(key, color_fallback):
        if images.get(key):
            ...
            return f"background-image: url('data:image/png;base64,{images[key]}'); background-size: 120% 120%; background-position: center; background-repeat: no-repeat; background-color: transparent !important;"
    ...
    st.markdown(
        ...
        <div class="hero-metric-grid">
            <!-- Card 1: Trust Score -->
            <div class="hero-metric" style="{get_bg_style('img2', '#0ea5e9')}; border: none !important; box-shadow: none !important; mix-blend-mode: screen; background-color: transparent !important; filter: saturate(1.8) brightness(1.2);">
                <div class="hero-metric-icon" style="background: none !important; border: none !important; mix-blend-mode: screen; filter: none !important;">
            ...
            <!-- Card 2: Streak -->
            <div class="hero-metric" style="{get_bg_style('img5', '#f97316')}; border: none !important; box-shadow: none !important; mix-blend-mode: screen; background-color: transparent !important; filter: saturate(1.8) brightness(1.2);">
                <div class="hero-metric-icon" style="background: none !important; border: none !important; mix-blend-mode: screen; filter: none !important;">
            ...
            <!-- Card 3: Success -->
            <div class="hero-metric" style="{get_bg_style('img7', '#10b981')}; border: none !important; box-shadow: none !important; mix-blend-mode: screen; background-color: transparent !important; filter: saturate(1.8) brightness(1.2);">
                <div class="hero-metric-icon" style="background: none !important; border: none !important; mix-blend-mode: screen; filter: none !important;">
